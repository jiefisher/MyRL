...
def get_patch_args(parser):
    ...
    group.add_argument(
        ...
        type=int,
        help="VLLM tensor parallel sizen",
    )

    group.add_argument(
        "--vllm-max-num-batched-tokens",
        type=int,
        help="VLLM max num batched tokens",
    )
    
    group.add_argument(
        "--vllm-temperature",
        type=float,
        help="VLLM temperature p inference",
    )
    
    group.add_argument(
        "--vllm-top-p",
        type=float,
        help="VLLM top p inference",
    )
    
    group.add_argument(
        "--vllm-max-new-tokens",
        type=int,
        help="the max tokens num of VLLM samples response length",
    )
